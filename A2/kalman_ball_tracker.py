...
class PID_controller:
    ...
    def get_fan_rpm(self, image_frame=None, position=None):
        ...
        if self.last_t is not None:
            #TODO
            #TODO implement the PID controller function and compute FAN rpm to reach the target position.
            fan_rpm = 1
...
if __name__ == '__main__':
    ...
    while not exit:
        ...
        print('en - Experiment Noisy Mode')
        ...
        for command in commands:
            ...
            if job == 'e' or job == 'v' or job == 'vs' or 'en' or 'vn':
                # graph_lock = Lock()
